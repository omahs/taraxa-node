...
TEST_F(TransactionTest, transaction_low_nonce) {
  ...
  trx_mgr.insertValidatedTransaction({trx_low_nonce, TransactionStatus::LowNonce});
  ...
  trx_mgr.insertValidatedTransaction({trx_insufficient_balance, TransactionStatus::InsufficentBalance});
